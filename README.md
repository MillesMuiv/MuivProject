# Coding project that focuses on fetching big amounts of data through APIs, saving, processing and visualising it through a user-frienly interface that doesn't require
